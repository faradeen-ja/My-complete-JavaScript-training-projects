...
btnLogin.addEventListener('click', function(e){ // e is for event / event is page auto load
  e.preventDefault();  //to remove browser default behaviour for reload
...
//////////////////////////////implement loan balance transfer//////////////////////////////
...
///every
/// we can simplify the functions and call back
...
// whit flatMap we get a big array of arrays in one 
